...
# ╔═╡ 6c9cdf40-9bec-41af-b91a-8fb1d51a7725
using PlutoUI, Plots

# ╔═╡ eef8d8e0-fe99-11ec-1f32-a503a0e87c44
md"# Variational Free Energy Simulator"

# ╔═╡ af0ace34-59b5-46f9-872b-5ce5fc245274
md"""
$$F[Q,y] = D_{KL}[Q(x) || P(x|y)] - \ln{P(y)}$$
"""

# ╔═╡ e168a876-2edf-4ed9-a5e7-26801820e08f
@bind s Slider(0:0.01:1)

# ╔═╡ 5a01923f-e13f-44a6-a09b-0a090bcf92bc
prior = [s 1-s]

# ╔═╡ f62dd608-b3e6-4ea2-be9c-e921b2d3b189
@bind l Slider(0:0.01:1)

# ╔═╡ 125de4c4-1e90-4549-8c35-e15b6d68f127
likelihood = [l 1-l; 1-l l]
